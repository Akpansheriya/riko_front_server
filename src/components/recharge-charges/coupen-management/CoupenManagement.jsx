    ...
    <div className="gift-management-main">
      <div className="top-section">
        ...
        <div className="right-section">
          <Button className="edit-btn">+ Create Coupen</Button>
        </div>
      </div>
      <div className="table">
        ...
        <div className="table-body">
          ...
          <div>
            <p className="heading-text">Welcome 70</p>
          </div>
          <div>
            <p className="heading-text">118.00</p>
          </div>
          <div>
          ...
          <div>
            <p className="heading-text">50.00</p>
          </div>
          <div>
            <p className="heading-text">10/12/2021</p>
          </div>
          <div>
