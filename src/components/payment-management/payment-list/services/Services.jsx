  ...
  return (
    <div className="services-main">
      <div className="table-headings">
        ...
        <div>
          <p className="heading-text">
            Transaction Type <img className="sort" src={sort} alt={sort} />
          </p>
        </div>
        <div>
          <p className="heading-text">
        ...
        <div>
          <p className="heading-text">
            Minute <img className="sort" src={sort} alt={sort} />
          </p>
        </div>
        <div>
          <p className="heading-text">
            Total Amount <img className="sort" src={sort} alt={sort} />
          </p>
        </div>
        <div>
          <p className="heading-text">
            Net Amount <img className="sort" src={sort} alt={sort} />
          </p>
        </div>
        <div>
          <p className="heading-text">
            Admin Commission <img className="sort" src={sort} alt={sort} />
          </p>
        </div>
        <div>
          <p className="heading-text">
      ...
      <div className="table-body">
        ...
        <div>
          <p className="heading-text">Credit</p>
        </div>
        <div>
          <p className="heading-text">Anil</p>
        </div>
        <div>
          <p className="heading-text">3</p>
        </div>
        <div>
        ...
        <div>
          <p className="heading-text">6.00</p>
        </div>
