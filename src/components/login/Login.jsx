...
function Login() {
  ...
  const { data: user, refetch, isLoading: isUserLoading, error: userError } = useGetMeQuery(null, {
    skip: !localStorage.getItem("token"), // Fetch user data only if token exists
  });
        ...
        <Col sm={12} md={6} lg={6}>
          <div className='form-section'>
            ...
            <Form onSubmit={handleSubmit}>
              ...
              <Button className='login-btn mt-3' variant='primary' type='submit' disabled={isLoading}>
