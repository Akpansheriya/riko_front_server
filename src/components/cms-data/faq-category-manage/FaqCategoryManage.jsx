...
function FaqCategoryManage() {
  return (
    <div className="faq-category-main">
      ...
      <div className="table">
        <div className="table-headings">
          ...
          <div>
            <p className="heading-text">Category Name</p>
          </div>
          <div>
        ...
        <div className="table-body">
          ...
          <div>
            <p className="heading-text">Category 1</p>
          </div>
...
export default FaqCategoryManage;
