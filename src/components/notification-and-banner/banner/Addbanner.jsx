...
import "./addbanner.scss"; // Include your styles here
        ...
        <Form>
          <Row className="mb-3">
            <Form.Group as={Col} controlId="formGridTitle">
              <Form.Label>Add Banner Title:</Form.Label>
              <Form.Control type="text" placeholder="Enter Banner Title" />
            </Form.Group>

            <Form.Group as={Col} controlId="formGridDetails">
              <Form.Label>Banner Details:</Form.Label>
              <Form.Control
                type="text"
